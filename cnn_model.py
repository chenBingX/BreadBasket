...
class CnnBreadBasketNetwork:
    def __init__(self):
        ...
        with tf.name_scope("hidden1"):
            ...
            tf.histogram_summary('activations_h_conv11', h_conv11)
            # 第二个卷积
            ...
            tf.histogram_summary('activations_h_conv12', h_conv12)
            # 池化
        ...
        with tf.name_scope("hidden2"):
            ...
            tf.histogram_summary('activations_h_conv21', h_conv21)
            # 第二层
            with tf.name_scope("weights2"):
            ...
            tf.histogram_summary('activations_h_conv22', h_conv22)
            # 池化
        ...
        with tf.name_scope("dropout1"):
            tf.scalar_summary('dropout_keep_probability1', self.keep_prob)
        ...
        #     tf.histogram_summary('activations_h_fc2', h_fc2)
        # with tf.name_scope("dropout2"):
        #     tf.scalar_summary('dropout_keep_probability2', self.keep_prob)
        ...
        with tf.name_scope("output"):
            ...
            self.y_conv = tf.nn.relu(tf.matmul(h_fc1_drop, W_out) + b_out)
